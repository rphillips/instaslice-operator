...
func TestMutatePodNvidiaResource(t *testing.T) {
	...
	for _, e := range envs {
		if e.Name == "NVIDIA_VISIBLE_DEVICES" {
			if e.ValueFrom == nil || e.ValueFrom.ConfigMapKeyRef == nil || e.ValueFrom.ConfigMapKeyRef.Name != "test" || e.ValueFrom.ConfigMapKeyRef.Key != "NVIDIA_VISIBLE_DEVICES" {
				t.Fatalf("invalid NVIDIA_VISIBLE_DEVICES env")
			}
			nvidiaEnv = true
		}
		if e.Name == "CUDA_VISIBLE_DEVICES" {
			if e.ValueFrom == nil || e.ValueFrom.ConfigMapKeyRef == nil || e.ValueFrom.ConfigMapKeyRef.Name != "test" || e.ValueFrom.ConfigMapKeyRef.Key != "CUDA_VISIBLE_DEVICES" {
...
func TestMutatePodEphemeralNvidiaResource(t *testing.T) {
	...
	for _, e := range envs {
		if e.Name == "NVIDIA_VISIBLE_DEVICES" {
			if e.ValueFrom == nil || e.ValueFrom.ConfigMapKeyRef == nil || e.ValueFrom.ConfigMapKeyRef.Name != "ephem" || e.ValueFrom.ConfigMapKeyRef.Key != "NVIDIA_VISIBLE_DEVICES" {
				t.Fatalf("invalid NVIDIA_VISIBLE_DEVICES env")
			}
			nvidiaEnv = true
		}
		if e.Name == "CUDA_VISIBLE_DEVICES" {
			if e.ValueFrom == nil || e.ValueFrom.ConfigMapKeyRef == nil || e.ValueFrom.ConfigMapKeyRef.Name != "ephem" || e.ValueFrom.ConfigMapKeyRef.Key != "CUDA_VISIBLE_DEVICES" {
				t.Fatalf("invalid CUDA_VISIBLE_DEVICES env")
			}
			cudaEnv = true
		}
...
func TestMutatePodOverrideValues(t *testing.T) {
	...
	for _, e := range envs {
		...
		case "NVIDIA_VISIBLE_DEVICES":
			if e.ValueFrom == nil || e.ValueFrom.ConfigMapKeyRef == nil || e.ValueFrom.ConfigMapKeyRef.Name != "override" || e.ValueFrom.ConfigMapKeyRef.Key != "NVIDIA_VISIBLE_DEVICES" {
				t.Fatalf("NVIDIA env not correctly set")
			}
		case "CUDA_VISIBLE_DEVICES":
			if e.ValueFrom == nil || e.ValueFrom.ConfigMapKeyRef == nil || e.ValueFrom.ConfigMapKeyRef.Name != "override" || e.ValueFrom.ConfigMapKeyRef.Key != "CUDA_VISIBLE_DEVICES" {
